...
def get_tf_expression(
    ...
    If `tf_expression_mode` is "actual", this function computes the mean TF expression
    ...
    tf_expression_mode : str
        Mode for TF expression. "actual" calculates per-topic TF expression from top-k cells,
...
def train_model_grn(
    ...
    if config_file.tf_expression_mode == "actual":
        topic_tf_input = get_tf_expression(
            config_file.tf_expression_mode,
            model,
            device,
